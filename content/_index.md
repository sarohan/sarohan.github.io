...
name = "Sagar Mohan"
# id = "sarohan"
bio = "Cybersecurity PhD Student at Northeastern"
# avatar = "img/avatar.webp"
links = [
    { name = "GitHub", icon = "github", url = "https://github.com/sarohan" },
    # { name = "Twitter", icon = "twitter", url = "https://twitter.com/<your-username>" },
    { name = "Mastodon", icon = "mastodon", url = "https://infosec.exchange/@sagar"},
    # { name = "Email", icon = "email", url = "mailto:<your-email-address>" },
    { name = "LinkedIn", icon = "linkedin", url = "https://www.linkedin.com/in/sagarmhn/"}
]
